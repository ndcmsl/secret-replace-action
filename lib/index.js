...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __nccwpck_require__(186);
const configFile = (0, core_1.getInput)('file');
const secrets = JSON.parse((0, core_1.getInput)('secrets'));
function replaceFile(string, variables) {
    return string.replace(/\{{([^}]*)}}/gm, (_, name) => variables[name]);
}
function main() {
    const fileParsed = replaceFile(configFile, secrets);
    (0, core_1.setOutput)('fileParsed', fileParsed);
}
try {
    main();
}
